...
# internal import
from book_shop.models import Product, db
from book_shop.forms import ProductForm
...
def shop():
    ...
    our_class = "Books are Amazing!"
                            #whats on left side is html, right side is whats in our route
    return render_template('shop.html', shop=allprods, message = our_class) #looking inside our template_folder (site_templates) to find our shop.html file
